...
- **Ders Kaynaklarındaki Durum:** Yazılım Süreç Modelleri anlatılırken "Barok Modeli" adında bir geleneksel modelden bahsedilmiş ve 1970'lerde kullanıldığı söylenmiştir.
...
- **Ders Kaynaklarındaki Durum:** Kodla ve düzelt, bir yazılım geliştirme süreci modeli olarak listelenmiştir. "Eğer onu yapanlar kullanacaksa avantajlıdır" gibi pozitif yanları belirtilmiştir.
...
- **Ders Kaynaklarındaki Durum:** "Gereksinimleri çok net ve kısa süreli projeler için uygundur."
...
- **Ders Kaynaklarındaki Durum:** RUP (Rational Unified Process) ve UP kapsamlı olarak işlenmektedir (4 Ana Aşama: Başlangıç, Hazırlık, Yapılandırma, Geçiş).
...
- **Ders Kaynaklarındaki Durum:** Agile'ın "1950'lerdeki üretim alanında verimliliğin artırılması için geliştirilen yalın yaklaşımların yazılım sektöründeki uzantısı" olduğu belirtiliyor.
...
- **Ders Kaynaklarındaki Durum:** AUP, ana Çevik Modeller listesinde sayılmış.
...
- **Ders Kaynaklarındaki Durum:** "Bir yinelemenin (Sprint) tanımlanması 30 günden fazla sürmemekte".
